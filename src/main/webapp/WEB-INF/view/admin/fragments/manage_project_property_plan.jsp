...
<script type="text/javascript">
    ...
    $("#block").on("change", function() {
    	populateFloorNumberSelector(blockDataHolder[$(this).prop('selectedIndex')].noOfFloor);
    });
    ...
    function fetchBlockData() {
        ...
        $.ajax({
            ...
            success : function(data) {
                ...
                populateFloorNumberSelector(blockDataHolder[blockSelector.prop('selectedIndex')].noOfFloor);
            },
            error : function(e) {
                if (counter == 5) {
			...
			success : function(data) {
				...
				for (division in data)
					$('#propertyType').append($('<option>', {
						value : data[$('#propertyType > option').length].propertyTypeID,
