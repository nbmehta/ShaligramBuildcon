    ...
    <body>
        ...
        <section>
            <div class="container">
                <div class="row row1">
                    <div class="col-md-12">
                        <h3 class="center capital f1 wow fadeInLeft" data-wow-duration="2s">Access Denied!</h3>
                        <h1 id="error" class="center wow fadeInRight" data-wow-duration="2s">0</h1>
                        <p class="center wow bounceIn" data-wow-delay="2s">You are not authorized to view this page!</p>
        ...
        <script type="text/javascript">
            "use strict";
            var count = new countUp("error", 0, 403, 0, 3);
